...
for i in temp_job_dataset:
   job_dataset.append(i[0])
...
def get_job_dataset(c_query, c_location, c_page_offset):
    ...
    temp_job_dataset.append(indeed_job_dataset)
    ...
    temp_job_dataset.append(neuvoo_job_dataset)
    total_job_count = total_job_count + int(neuvoo_j_count)
   
   
    return temp_job_dataset
